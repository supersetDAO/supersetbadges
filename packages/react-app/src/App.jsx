...
const providers = [
  ...
  "https://goerli.infura.io/v3/198915bae74845c589b42d59fa992d9b",
...
function App(props) {
  ...
  */
  ...
  // const dContract = useContractLoader(injectedProvider, contractConfig, selectedChainId);

  return (
    <div className="App">
      {/* ✏️ Edit the header and change the title to your project name */}
      <Header>
        {console.log(writeContracts, "writeContract")}
      ...
      <Menu style={{ textAlign: "center", marginTop: 20 }} selectedKeys={[location.pathname]} mode="horizontal">
        <Menu.Item key="/">
          <Link to="/">Badge Data</Link>
        </Menu.Item>
        <Menu.Item key="/hints">
          <Link to="/hints">Contract Information</Link>
        </Menu.Item>
        <Menu.Item key="/exampleui">
          <Link to="/exampleui">Metadata Builder</Link>
        </Menu.Item>
        <Menu.Item key="/debug">
          <Link to="/debug">Contract Interface</Link>
        </Menu.Item>
        {/* <Menu.Item key="/mainnetdai">
          <Link to="/mainnetdai">Mainnet DAI</Link>
        </Menu.Item> */}
        <Menu.Item key="/subgraph">
          <Link to="/subgraph">Subgraph Playground</Link>
        </Menu.Item>
      </Menu>
      ...
      <Switch>
        ...
        <Route path="/hints">
          <Hints address={address} yourLocalBalance={yourLocalBalance} mainnetProvider={mainnetProvider} price={1} />
        </Route>
